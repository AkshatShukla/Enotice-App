...
public class PdfUploadAuthority extends AppCompatActivity {
    private File root;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_upload_authority);
    ...
    private void startPosting(String string) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View v, final int position, long arg3) {
                ...
                new BottomDialog.Builder(PdfUploadAuthority.this)
                        ...
                        .onPositive(new BottomDialog.ButtonCallback() {
                            ...
                            public void onClick(BottomDialog dialog) {
                                ...
                                final AlertDialog dialog1 = new SpotsDialog(PdfUploadAuthority.this, R.style.CustomProgress);
                                dialog1.show();
                                ...
                                filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        mDataUser.addValueEventListener(new ValueEventListener() {
                                                ...
                                                newPost.child("approved").setValue(Approved).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(PdfUploadAuthority.this, "Uploaded Successfully", Toast.LENGTH_LONG).show();
                                                            departmentPushAuthority(TitleText, "Notice by HOD ".concat(dataSnapshot.child("name").getValue().toString()), Dept);
                                                        }
                                                    }
                                                });
                                            }
                                            ...
                                            @Override
                                            public void onCancelled(DatabaseError databaseError) {
                                                Toasty.error(PdfUploadAuthority.this, "Connection Error").show();
                                            }
                                        });

                                        dialog1.dismiss();
                                        startActivity(new Intent(PdfUploadAuthority.this, AddNoticeTabbedAuthority.class));
                                        finish();
